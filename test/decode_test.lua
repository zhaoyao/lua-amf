...
describe('amf3', function() 
    ...
    it("should keep reference of duplicate object traits", function() 
        assert_decoded(3, 'amf3-trait-ref.bin', {{__class = 'org.amf.ASClass', foo='foo'}, {__class = 'org.amf.ASClass', foo='bar'}})
    end)
    ...
    it("should deserialize a typed object", function ()
        local output, err, pos = amf.decode(3, object_fixture('amf3-typed-object.bin'))
        assert_eql({foo='bar', __class = 'org.amf.ASClass'}, output)
    end)
end)
